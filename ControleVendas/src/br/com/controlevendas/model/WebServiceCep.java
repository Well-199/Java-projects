...
public final class WebServiceCep {
	...
	private static Document getDocument(String cep) 
		...
		URL url = new URL(String.format(URL_STRING, cep));
                ...
                // o cep como argumento é esperado no parametro %s na url
                // URL COM PARAMETRO: http://cep.republicavirtual.com.br/web_cep.php?cep=%s&formato=xml
                // COM VALOR NO PARAMETRO: http://cep.republicavirtual.com.br/web_cep.php?cep=08210-770&formato=xml
                // CASO QUEIRA FORMATO JSON: http://cep.republicavirtual.com.br/web_cep.php?cep=08210-770&formato=json
