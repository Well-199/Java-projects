...
public class FrmFuncionarios extends javax.swing.JFrame {
    ...
    // Metodo Listar Funcionarios na Tabela
    public void listarFuncionariosTabela(){
        
        FuncionariosDao dao = new FuncionariosDao();
        /*
            Em lista eu recebo o retorno da execução do metodo listarFuncionarios
            com todos os itens que foram inseridos na lista na classe FuncionariosDao
            dentro do while com lista.add(funcionario)
            e depois foi retornado a lista que eu tenho acesso aqui
        */
    ...
    private void initComponents() {
        ...
        txtcargo.setFont(new java.awt.Font("Helvetica Neue", 0, 14)); // NOI18N
        ...
        cbnivel.setFont(new java.awt.Font("Helvetica Neue", 0, 14)); // NOI18N
                            ...
                            .addGroup(painel_dados_pessoaisLayout.createSequentialGroup()
                                .addGroup(painel_dados_pessoaisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, painel_dados_pessoaisLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cbnivel, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, painel_dados_pessoaisLayout.createSequentialGroup()
                                        .addGap(12, 12, 12)
        ...
        tabelaFuncionarios.setFont(new java.awt.Font("Helvetica Neue", 0, 14)); // NOI18N
        ...
        tabelaFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "RG", "CPF", "Email", "Senha", "Cargo", "Nível Acesso", "Telefone", "Celular", "CEP", "Endereço", "Numero", "Complemento", "Bairro", "Cidade", "UF"
            }
        ) {
        ...
        jTabbedPane2.addTab("Consulta de funcionários", jPanel3);
    ...
    private void btneditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditarActionPerformed
        ...
        obj.setSenha(textpassword.getPassword().toString());
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        ...
        obj.setSenha(textpassword.getPassword().toString());
        obj.setCargo(txtcargo.getText());
        obj.setNivel_acesso(txtbairro.getText());
        obj.setTelefone(txtfixo.getText());
        obj.setCelular(txtcelular.getText());
    ...
    private void tabelaFuncionariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaFuncionariosMouseClicked
        ...
        */  
        ...
        textpassword.setText(tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(), 5).toString());
        txtcargo.setText(tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(), 6).toString());
        cbuf.setSelectedItem(tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(), 7).toString());
    ...
    private void btnConsultaCpfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaCpfActionPerformed
        ...
        funcionario = dao.buscaFuncionarioPorCPF(cpf);
        ...
        textpassword.setText(funcionario.getSenha());
